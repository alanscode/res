...
<head>
    ...
    <script>var isMobile = false;</script>
      ...
      <link href="web/css/website.css" rel="stylesheet" />
...
<body>
    ...
    <!-- Google Tag Manager -->
    <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-TRMWZ5"
    ...
    <div id="webcontainer" class="main-Container" style="width: 100%; overflow: hidden; display:block;">
        <div id="panelsI">
            ...
            <div id="panel1" class="panel" style="">
                ...
                <div class="form-title joystixP" id="form-copy">
                    <img src="web/images/NEW-COPY.png" width="100%" /><div onclick="fullScreen('#foundation', 1, 2);" style=" position: absolute; height: 22%; width: 37%; bottom: 70%; left: 61%; cursor: pointer; "></div>
                    <div onclick="slideToPrize();" style="position: absolute; height: 20%; width: 6%; bottom: 23%; left: 93%; cursor: pointer;"></div>
                </div>

                <div class="form-title joystixP" id="form-copy-thankyou" style="display:none;">
				<img src="web/images/form-thanks.png" width="100%" />
                    <div onclick="fullScreen('#foundation', 1, 2);" style=" position: absolute; height: 20%; width: 37%; bottom: 52%; left: 11%; cursor: pointer; "></div>
                    <div onclick="slideRight();" style="position: absolute; height: 20%; width: 15%; bottom: 27%; left: 46%; cursor: pointer;"></div>
				</div>
                <div class="form-title joystixP" id="form-copy-registerednotplayed" style="display:none;"><img src="web/images/form-thanks-play-for-bonus.png" width="100%" />
                    <div onclick="slideRight();" style="position: absolute; height: 36%; width: 18%; bottom: 27%; left: 13%; cursor: pointer; top: 57%;"></div>
                </div>
                ...
                <div class="thank-you joystixP" style="display: none; position: absolute; top: 45%;left: 0;right: 0;margin: auto;width: 30%;"><img src="web/images/thanks.png" style=" width: 100%; "/></div>
                ...
                <div class="form-wrapper">
                    ...
                    <form id="gameform">
                        ...
                        <div id="rules">
                            ...
                            <div class="privacy-top" style=" position: absolute; left: 9%; width: 75%; "><img src="web/images/rules.png" style="width:100%;"/></div>
                            <div style="position: absolute; width: 17%; height: 5%; left: 44%;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="web/rules/HondaClassic_OfficialRules.pdf" target="_blank"></a></div>
                            <div style="position: absolute; width: 17%; height: 5%; left: 66%;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="http://automobiles.honda.com/information/consumer-privacy-policy.aspx" target="_blank"></a></div>
                        ...
                        <div id="emails">
                            ...
                            <div class="privacy-bttm" style=" position: absolute; left: 9%; width: 75%; "><img src="web/images/yes.png" style="width:100%;" /></div>
                        ...
                        <div class="buttons" style="margin-top: 3%; float: none;">
                            <img src="web/images/submit.png" class="submit" style=" width: 100%; "/><img src="web/images/maximum.png" class="" style=" width: 75%; margin-top: 10px; "/>
                        </div>
                    </form>
                ...
                <div style=" width: 6%; position: absolute; bottom: 2%; height: 3%; right: 21%;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="http://www.shophonda.com/" target="_blank"></a></div>
                <div style="width: 16%;height: 2%;left: 32%;bottom: 1%;position: absolute;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="web/rules/HondaClassic_OfficialRules.pdf" target="_blank"></a></div>
               </div>
            <div id="panel2" class="panel" style="">
               ...
               <div style=" width: 6%; position: absolute; bottom: 2%; height: 3%; right: 23%;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="http://www.shophonda.com/" target="_blank"></a></div>
            ...
            <div id="panel3" class="panel" style="">
                ...
                <div style="width: 16%;height: 2%;left: 41%;bottom: 1%;position: absolute;"><a style="position: relative; display: block; height: 100%; width: 100%;" href="web/rules/HondaClassic_OfficialRules.pdf" target="_blank"></a></div>
            </div>
            <div class="clouds">
        ...
        <div class="lightbox" id="foundation" style="">
            <div><img src="web/images/charity_popup.png" style="width:737px; height:377px" /></div>
    ...
    <div id="gamecontainer" class="game-Container">
        <div id="pausemenu">
            ...
            <div id="resumex" style="background: url('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBR‌​AA7') 0 0 repeat;"></div>
            <div id="resume" style="background: url('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBR‌​AA7') 0 0 repeat;"></div>
            <div id="quit" style="background: url('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBR‌​AA7') 0 0 repeat;"></div>
            <div id="shopLink" style="background: url('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBR‌​AA7') 0 0 repeat;"></div>
    ...
    <div id="leadercontainer" class="leaderboard-main-Container" style="width: 100%; overflow: hidden; display:none;">
        <div id="lb-panel" class="panel" style="">
            <div id="inner-container" style="">
                ...
                <!--social-->
                <div class="fb" style="position: relative; width: 5%; height: 8%; left: 74.5%; bottom: 10%; cursor:pointer;"><a href="https://www.facebook.com/sharer/sharer.php?u=wtfdude" target="_blank" style="display: block; width: 100%; height: 100%;" onclick="dataLayer.push({'event': 'btn_leaderboard_facebook'});"></a></div>
...
.
    <script type="text/javascript">
        ...
        document.write('<iframe src="https://4114413.fls.doubleclick.net/activityi;src=4114413;type=honda751;cat=honda0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=1;num=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
    </script>
